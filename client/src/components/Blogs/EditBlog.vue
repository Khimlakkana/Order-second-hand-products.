<template>
  <div>
    ...
    <form class="box1" v-on:submit.prevent="editBlog">
      ...
      <p> ชื่อสินค้า :
        <select required class="form-control"  v-model="blog.room">
      ...
      <p> จำนวนผู้เข้าดูสินค้า : <input type="number" class="form-control" required v-model="blog.pnum" /></p>
